...
hMass3LH = ROOT.TH1F('h_3lh_mass', r'; m({}^{3}_{#Lambda}H) (GeV/#it{c})', 20, 2.96, 3.04)
...
h2MassV2 = ROOT.TH2F('h2MassV2', r';m({}^{3}_{#Lambda}H) (GeV/#it{c}); v2', 20, 2.96, 3.04, 500, -1, 1)
hMeanV2VsMass = ROOT.TH1F('hMeanV2VsMass', r';m({}^{3}_{#Lambda}H) (GeV/#it{c}); #LT v2 #GT', 20, 2.96, 3.04)
...
# create directory for histograms as pdf
if not os.path.exists(f'{output_dir_name}/qa_plots'):
   os.makedirs(f'{output_dir_name}/qa_plots')
