...
if __name__ == '__main__':
    ...
    yield_dist = ROOT.TH1D('syst_yield', ';dN/dy ;Counts', 40, 120, 380)
    yield_prob = ROOT.TH1D('prob_yield', ';prob. ;Counts', 100, 0, 1)
    ...
    if do_syst:
        ...
        for i_combo, combo_indices in enumerate(combo_random_indices):
            ...
            if spectra_maker.fit_func.GetProb() > 0.05:
                ...
                spectra_maker.dump_to_output_dir()
                yield_dist.Fill(spectra_maker.fit_func.GetParameter(1))
