...
# python3 analyse_tree.py --config-file configs/analysis/config_matter.yaml
# python3 analyse_tree.py --config-file configs/analysis/config_mc.yaml
# python3 signal_extraction.py --config-file configs/signal_extraction/config_signal_extraction_mat.yaml
