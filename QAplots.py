...
utils.setHistStyle(hResolutionP, ROOT.kAzure+2)
...
utils.fill_th2_hist_abs(hResolutionPtvsPt, mc_hdl, 'fAbsGenPt', 'resPt')
...
c2MassCosPA_MC.SetRightMargin(1.2)
...
c2MassDecLen_MC.SetRightMargin(1.2)
...
c2MassDCADaughters_MC.SetRightMargin(1.2)
...
c2MassDCAHePv_MC.SetRightMargin(1.2)
...
hResolutionP.Write()
cResolutionP.SaveAs(f'{qa_dir_name}/cResolutionP.pdf')
...
cResolutionPvsP.SaveAs(f'{qa_dir_name}/cResolutionPvsP.pdf')
