GENERAL_FILE="/data/lbariogl/hyp_mc/fmazzasc_sim/AnalysisResults.root"
...
NEW_TOT_FILE="../results/fmazzasc_sim/HypertritonResults_inj_gap_tot.root"
if [ -f "$NEW_TOT_FILE" ]; then
  echo "Removing $NEW_TOT_FILE"
  rm $NEW_TOT_FILE
fi
hadd $NEW_TOT_FILE ../results/fmazzasc_sim/HypertritonResults_inj_gap_matter.root ../results/fmazzasc_sim/HypertritonResults_inj_gap_antimatter.root
